...
<%--		</div>--%>
		<br>
			<div class="tanchu" style="background-color: #f9f9f9;height: 240px;width: 330px;border-radius:10px;">
				<div>
	...
	<div style="float: left;margin-top: 10px;margin-left: 90px;margin-right: 30px;">
		...
		<div style="position:fixed;margin-top: 70px;width: 1535px;background-color:#C0C0C0;">
		...
		<button type="button" class="btn btn-primary"  onclick="guanlilogin()"><span class="glyphicon glyphicon-user"></span> 管理员登录</button>
	...
	<thead>
		<tr>
			...
			<th class="col-md-2" style="text-align:left;"><h2>${di.dname }</h2></th>
			...
			<th class="col-md-2"><h2 style="margin-left: 50px;">${di.price }元</h2></th>
			<th class="col-md-2">
				<div id="dj">
				
					<button id="butjia" class="btn-success" did="${di.id }" na="${di.vid }" onclick="add1(this)" style="border-radius:10px;" data-toggle="modal" data-target="#myModal">加入购物车</button>
